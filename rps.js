...
function runRPS(wrapperContent) {
  ...
  rpsContainer.animate([{ opacity: 1 }], {
    duration: 1000,
    iterations: 1,
    fill: 'forwards',
  });

  wrapperContent.animate([{ opacity: 0 }], {
    duration: 500,
    iterations: 1,
    fill: 'forwards',
  });
...
function animate() {
  userImage.animate([{ transform: 'translateY(-50px) rotate(90deg)' }], {
    duration: 300,
    iterations: 6,
    direction: 'alternate',
  });

  computerImage.animate([{ transform: 'translateY(-50px) scaleX(-1) rotate(90deg)' }], {
    duration: 300,
    iterations: 6,
    direction: 'alternate',
  });
